-- Migration: Add user entity type to translation system
-- This migration adds support for translating user names
...
-- Recreate check constraint with 'user' entity type added
ALTER TABLE translation_metadata 
...
-- Update the check_translation_metadata_access function to handle 'user' entity type
