...
**Frontend Variables:**
- `NEXT_PUBLIC_API_URL` - Your backend API URL (use `http://localhost:5001/api/v1` for local, or your public server URL for production)
...
- **Host Port**: 5001 (maps to container port 3001)

### Frontend Service
- **Container Name**: `rms-frontend`
- **Host Port**: 5000 (maps to container port 3000)
...
2. Update `FRONTEND_URL` to your production frontend URL (e.g., `http://your-server-ip:5000` or `https://your-domain.com`)
3. Update `NEXT_PUBLIC_API_URL` to your production backend URL (e.g., `http://your-server-ip:5001/api/v1` or `https://api.your-domain.com/api/v1`)
